...
$.ajax({
    ...
    data: {
        key: 'XRYBZ-O3URT-TEDXF-LUKOA-SGY33-3IFLW',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(105.96855818057804, 36.98247220138091, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
